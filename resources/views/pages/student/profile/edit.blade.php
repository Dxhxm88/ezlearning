                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('student.profile.editing') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                <input id="ic_num" type="text" class="form-control @error('ic_num') is-invalid @enderror" name="ic_num" value="{{ $student->ic }}" required autocomplete="ic_num" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                <textarea id="address" class="form-control @error('address') is-invalid @enderror" name="address" required autocomplete="address" autofocus>{{ $student->address }}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                <input id="phone" type="tel" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{ $student->phone }}" required autocomplete="phone" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                <select name="classs" class="form-control form-select" required>
                                    {{-- <option value="{{ $student->classs_id }}" selected>{{ $student->classs_name }}</option> --}}
                                    @foreach ($classses as $classs)
                                        <option value="{{ $classs->id }}" {{ $classs->id == $student->classs_id ? 'selected' : '' }} >{{ $classs->name }}</option>
                                    @endforeach
                                </select>
